        ...
        for record in self:
            ...
            if record.dhl_delivery_event_flag != '1':
                ...
                if xml_response.startswith('<?xml'):
                    ...
                    record.dhl_code = (record.ownership and xml_response_dict['data']['@' + constants_dhl.CODE]) or (not record.ownership and xml_response_dict['data']['data']['@' + constants_dhl.CODE])
                    
                    if record.dhl_code != '0':
                        record.error_occurred = True
                        record.error_counter = (not record.error_counter and 1) or (record.error_counter + 1)
                        record.dhl_error = (record.ownership and xml_response_dict['data']['@' + constants_dhl.ERROR]) or (not record.ownership and xml_response_dict['data']['data']['@' + constants_dhl.ERROR])
                        record.error = record.dhl_error
                        _logger.error(record.dhl_code + ": " + record.dhl_error)
                        record.stock_dm_state_id = self.env.ref('ama_delivery.dms70').id
                        if record.error_counter >= 5:
                            record.auto_tracking = False
                        else:
                        ...
                        record.error = ''
                        record.dhl_airway_bill_number = (record.ownership and xml_response_dict['data']['data']['@' + constants_dhl.AIRWAY_BILL_NUMBER]) or (not record.ownership and xml_response_dict['data']['data']['data']['@' + constants_dhl.AIRWAY_BILL_NUMBER])
                        record.dhl_delivery_event_flag = (record.ownership and xml_response_dict['data']['data']['@' + constants_dhl.DELIVERY_EVENT_FLAG]) or (not record.ownership and xml_response_dict['data']['data']['data']['@' + constants_dhl.DELIVERY_EVENT_FLAG])
                        record.dhl_dest_country = (record.ownership and xml_response_dict['data']['data']['@' + constants_dhl.DEST_COUNTRY]) or (not record.ownership and xml_response_dict['data']['data']['data']['@' + constants_dhl.DEST_COUNTRY])
                        record.dhl_division = (record.ownership and xml_response_dict['data']['data']['@' + constants_dhl.DIVISION]) or (not record.ownership and xml_response_dict['data']['data']['data']['@' + constants_dhl.DIVISION])
                        record.dhl_domestic_id = (record.ownership and xml_response_dict['data']['data']['@' + constants_dhl.DOMESTIC_ID]) or (not record.ownership and xml_response_dict['data']['data']['data']['@' + constants_dhl.DOMESTIC_ID])
                        record.dhl_error_status = (record.ownership and xml_response_dict['data']['data']['@' + constants_dhl.ERROR_STATUS]) or (not record.ownership and xml_response_dict['data']['data']['data']['@' + constants_dhl.ERROR_STATUS])
                        record.dhl_event_country = (record.ownership and xml_response_dict['data']['data']['@' + constants_dhl.EVENT_COUNTRY]) or (not record.ownership and xml_response_dict['data']['data']['data']['@' + constants_dhl.EVENT_COUNTRY])
                        record.dhl_event_location = (record.ownership and xml_response_dict['data']['data']['@' + constants_dhl.EVENT_LOCATION]) or (not record.ownership and xml_response_dict['data']['data']['data']['@' + constants_dhl.EVENT_LOCATION])
                        record.dhl_ice = (record.ownership and xml_response_dict['data']['data']['@' + constants_dhl.ICE]) or (not record.ownership and xml_response_dict['data']['data']['data']['@' + constants_dhl.ICE])
                        record.dhl_identifier_type = (record.ownership and xml_response_dict['data']['data']['@' + constants_dhl.IDENTIFIER_TYPE]) or (not record.ownership and xml_response_dict['data']['data']['data']['@' + constants_dhl.IDENTIFIER_TYPE])
                        record.dhl_international_flag = (record.ownership and xml_response_dict['data']['data']['@' + constants_dhl.INTERNATIONAL_FLAG]) or (not record.ownership and xml_response_dict['data']['data']['data']['@' + constants_dhl.INTERNATIONAL_FLAG])
                        record.dhl_leitcode = (record.ownership and xml_response_dict['data']['data']['@' + constants_dhl.LEITCODE]) or (not record.ownership and xml_response_dict['data']['data']['data']['@' + constants_dhl.LEITCODE])
                        record.dhl_matchcode = (record.ownership and xml_response_dict['data']['data']['@' + constants_dhl.MATCHCODE]) or (not record.ownership and xml_response_dict['data']['data']['data']['@' + constants_dhl.MATCHCODE])
                        record.dhl_order_preferred_delivery_date = (record.ownership and xml_response_dict['data']['data']['@' + constants_dhl.ORDER_PREFERRED_DELIVERY_DAY]) or (not record.ownership and xml_response_dict['data']['data']['data']['@' + constants_dhl.ORDER_PREFERRED_DELIVERY_DAY])
                        record.dhl_origin_country = (record.ownership and xml_response_dict['data']['data']['@' + constants_dhl.ORIGIN_COUNTRY]) or (not record.ownership and xml_response_dict['data']['data']['data']['@' + constants_dhl.ORIGIN_COUNTRY])
                        record.dhl_pan_recipient_address = (record.ownership and xml_response_dict['data']['data']['@' + constants_dhl.PAN_RECIPIENT_ADDRESS])
                        record.dhl_pan_recipient_city = (record.ownership and xml_response_dict['data']['data']['@' + constants_dhl.PAN_RECIPIENT_CITY]) or (not record.ownership and xml_response_dict['data']['data']['data']['@' + constants_dhl.PAN_RECIPIENT_CITY])
                        record.dhl_pan_recipient_name = (record.ownership and xml_response_dict['data']['data']['@' + constants_dhl.PAN_RECIPIENT_NAME]) or (not record.ownership and xml_response_dict['data']['data']['data']['@' + constants_dhl.PAN_RECIPIENT_NAME])
                        ...
                        record.dhl_pan_recipient_street = (record.ownership and xml_response_dict['data']['data']['@' + constants_dhl.PAN_RECIPIENT_STREET]) or (not record.ownership and xml_response_dict['data']['data']['data']['@' + constants_dhl.PAN_RECIPIENT_STREET])
                        record.dhl_piece_code = (record.ownership and xml_response_dict['data']['data']['@' + constants_dhl.PIECE_CODE]) or (not record.ownership and xml_response_dict['data']['data']['data']['@' + constants_dhl.PIECE_CODE])
                        ...
                        record.dhl_piece_id = (record.ownership and xml_response_dict['data']['data']['@' + constants_dhl.PIECE_ID]) or (not record.ownership and xml_response_dict['data']['data']['data']['@' + constants_dhl.PIECE_ID])
                        record.dhl_piece_identifier = (record.ownership and xml_response_dict['data']['data']['@' + constants_dhl.PIECE_IDENTIFIER]) or (not record.ownership and xml_response_dict['data']['data']['data']['@' + constants_dhl.PIECE_IDENTIFIER])
                        record.dhl_product_code = (record.ownership and xml_response_dict['data']['data']['@' + constants_dhl.PRODUCT_CODE]) or (not record.ownership and xml_response_dict['data']['data']['data']['@' + constants_dhl.PRODUCT_CODE])
                        record.dhl_product_key = (record.ownership and xml_response_dict['data']['data']['@' + constants_dhl.PRODUCT_KEY])
                        record.dhl_product_name = (record.ownership and xml_response_dict['data']['data']['@' + constants_dhl.PRODUCT_NAME]) or (not record.ownership and xml_response_dict['data']['data']['data']['@' + constants_dhl.PRODUCT_NAME])
                        record.dhl_pslz_nr = (record.ownership and xml_response_dict['data']['data']['@' + constants_dhl.PSLZ_NR]) or (not record.ownership and xml_response_dict['data']['data']['data']['@' + constants_dhl.PSLZ_NR])
                        record.dhl_recipient_city = (record.ownership and xml_response_dict['data']['data']['@' + constants_dhl.RECIPIENT_CITY])
                        record.dhl_recipient_id = (record.ownership and xml_response_dict['data']['data']['@' + constants_dhl.RECIPIENT_ID]) or (not record.ownership and xml_response_dict['data']['data']['data']['@' + constants_dhl.RECIPIENT_ID])
                        record.dhl_recipient_id_text = (record.ownership and xml_response_dict['data']['data']['@' + constants_dhl.RECIPIENT_ID_TEXT]) or (not record.ownership and xml_response_dict['data']['data']['data']['@' + constants_dhl.RECIPIENT_ID_TEXT])
                        record.dhl_recipient_name = (record.ownership and xml_response_dict['data']['data']['@' + constants_dhl.RECIPIENT_NAME]) or (not record.ownership and xml_response_dict['data']['data']['data']['@' + constants_dhl.RECIPIENT_NAME])
                        record.dhl_recipient_street = (record.ownership and xml_response_dict['data']['data']['@' + constants_dhl.RECIPIENT_STREET])
                        record.dhl_ric = (record.ownership and xml_response_dict['data']['data']['@' + constants_dhl.RIC]) or (not record.ownership and xml_response_dict['data']['data']['data']['@' + constants_dhl.RIC])
                        ...
                        record.dhl_searched_piece_code = (record.ownership and xml_response_dict['data']['data']['@' + constants_dhl.SEARCHED_PIECE_CODE]) or (not record.ownership and xml_response_dict['data']['data']['data']['@' + constants_dhl.SEARCHED_PIECE_CODE])
                        record.dhl_searched_ref_no = (record.ownership and xml_response_dict['data']['data']['@' + constants_dhl.SEARCHED_REF_NO]) or (not record.ownership and xml_response_dict['data']['data']['data']['@' + constants_dhl.SEARCHED_REF_NR])
                        ...
                        record.dhl_shipment_height = (record.ownership and xml_response_dict['data']['data']['@' + constants_dhl.SHIPMENT_HEIGHT]) or (not record.ownership and xml_response_dict['data']['data']['data']['@' + constants_dhl.SHIPMENT_HEIGHT])
                        record.dhl_shipment_length = (record.ownership and xml_response_dict['data']['data']['@' + constants_dhl.SHIPMENT_LENGTH]) or (not record.ownership and xml_response_dict['data']['data']['data']['@' + constants_dhl.SHIPMENT_LENGTH])
                        record.dhl_shipment_weight = (record.ownership and xml_response_dict['data']['data']['@' + constants_dhl.SHIPMENT_WEIGHT]) or (not record.ownership and xml_response_dict['data']['data']['data']['@' + constants_dhl.SHIPMENT_WEIGHT])
                        record.dhl_shipment_width = (record.ownership and xml_response_dict['data']['data']['@' + constants_dhl.SHIPMENT_WIDTH]) or (not record.ownership and xml_response_dict['data']['data']['data']['@' + constants_dhl.SHIPMENT_WIDTH])
                        ...
                        record.dhl_standard_event_code = (record.ownership and xml_response_dict['data']['data']['@' + constants_dhl.STANDARD_EVENT_CODE]) or (not record.ownership and xml_response_dict['data']['data']['data']['@' + constants_dhl.STANDARD_EVENT_CODE])
                        record.dhl_status = (record.ownership and xml_response_dict['data']['data']['@' + constants_dhl.STATUS]) or (not record.ownership and xml_response_dict['data']['data']['data']['@' + constants_dhl.STATUS])
                        ...
                        record.dhl_upu = (record.ownership and xml_response_dict['data']['data']['@' + constants_dhl.UPU]) or (not record.ownership and xml_response_dict['data']['data']['data']['@' + constants_dhl.UPU])
