...
class ama_del_stock_picking(models.Model):
    ...
    mail_sent = fields.Boolean(string='Lieferschein versendet', help='Lieferschein und Versandlabel wurden per E-Mail versendet', default=False, copy=False)
    delivery_done = fields.Boolean(string='Lieferung vollzogen', compute='_compute_delivery_done', help='Markiert ob alle zugehoerigen Sendungen abgeschlossen sind.', default=False, copy=False)
    ...
    carrier_label = fields.Many2one('ir.attachment', ondelete='restrict', string="Frachtführer Label", readonly=True, store=True, copy=False)
    ...
    carrier_status_code = fields.Char('Frachtführer Status-Code', readonly=True, copy=False)
    carrier_status_message = fields.Char('Frachtführer Status-Message', readonly=True, copy=False)
